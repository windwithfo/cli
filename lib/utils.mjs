 ...
 */
export function copyTemp(dir, dirName) {
 ...
 * @param {String} pkg 使用的包管理工具命令
 */
export function initTemp(dirName, pkg) {
  // npm install
 ...
 * 
 * @param {String} dirName 文件夹名
 * @param {String} build 构建工具
 * @param {String} page 页面类型
 */
export function buildTemp(dirName, build, page) {
  Log('project build ...')
  const single = page === 'single' ? true : false

  return new Promise(function(resolve, reject) {
    execCmd(`node build/init.mjs --single=${single} --build=${build}`, {
