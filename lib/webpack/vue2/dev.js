...
const { VueLoaderPlugin } = require(process.cwd() + '/node_modules/vue-loader/lib')
...
const webpackConfig = merge(baseConfig, {
  ...
  module: {
    rules: [
      ...
      ...(config.webpack.dev.useEslint ? [createJsLintingRule(), createVueLintingRule()] : [])
    ]
  },
  ...
  plugins: [
    ...
    ...(config.webpack.dev.useStylelint ? [new Linter({
      ...
      files: [`src/**/*.${config.webpack.dev.lintStyle || 'scss'}`, 'src/**/*.vue'],
